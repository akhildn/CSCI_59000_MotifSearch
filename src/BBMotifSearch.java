...
public class BBMotifSearch {

    private static final int NUM_OF_ACIDS = 4;

    public static MotifSearchResponse branchBoundMotifSearch(List<String> dnaSeq, int numOfSeq
            , int lengthOfSeq, int motifLen) {
    ...
    private static MotifSearchResponse nextVertex(int[] startSequences, int level, int numOfSeq, int i) {
        //Thread.sleep(10);
    ...
    public static int getScore(int[] startSeq, int level, List<String> dnaSeq, int motifLen) {
